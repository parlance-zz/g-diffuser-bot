...
while var1 <= var1_max:                                         # it's a loop, what do you want
    ...
    if debug: print(f"debug: {folder_name}/{var1_is} {var1_pad}")  # print the name of the folder we just generated to console for debugging
    var1 = var1 + var1_i                                           # iterate loop 1
    var2 = var2_min                                                # reinitialize loop 2

if debug: print(f"debug final: {comp_list}")                    # print the list of folders for debugging
