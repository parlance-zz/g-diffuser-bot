...
#my_prompt = "A highly detailed epic cinematic concept art cg render digital painting artwork: artificial intelligence. by greg rutkowski, in the style of francis bacon and syd mead and norman rockwell and beksinski, open ceiling, highly detailed, painted by francis bacon and edward hopper, painted by james gilleard, surrealism, airbrush, ilya kuvshinov, wlop, stanley artgerm, very coherent, triadic color scheme, art by takato yamamoto and james jean"
my_prompt = "Fujifilm XT3, 80mm Sigma f/1.4"
...
expand_bottom = 40        # these values are in % of the original image size
expand_left = 40          # exceeding 50% in any direction is not recommended for recursive zooms / pans
expand_right = 40
