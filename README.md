...
## Installation:
 ...
 7)  If you haven't already, sign up for an account at https://huggingface.co/, then accept the terms of use for the model repositories that you wish to use (https://huggingface.co/CompVis/stable-diffusion-v1-4, https://huggingface.co/hakurei/waifu-diffusion). Go to https://huggingface.co/settings/tokens and create a new access token. Open g_diffuser_config.py and find line 54 (GRPC_SERVER_SETTINGS.hf_token = "YOUR_HUGGINGFACE_ACCESS_TOKEN_HERE"); replace this placeholder text with the access token you just generated and save the file. If you wish to use the Discord bot, this file is also where you should enter your Discord bot token and guild id.
