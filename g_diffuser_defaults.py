...
DEFAULT_SAMPLE_SETTINGS.noise_start = 0.42                   # default strength for pure img2img or style transfer
...
DEFAULT_SAMPLE_SETTINGS.scale = 6.5                          # default cfg scale
DEFAULT_SAMPLE_SETTINGS.steps = 16                           # default number of sampling steps, lower to reduce sampling time
